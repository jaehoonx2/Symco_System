...
public class Mainscreen_summer implements Mainscreen{
	...
	public static void exec(ArrayList<Employee> employee) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Mainscreen_summer window = new Mainscreen_summer(employee);
	...
	public Mainscreen_summer(ArrayList<Employee> employee){
		initialize(employee);
	}
	...
	private void initialize(ArrayList<Employee> employee) {
		...
		lblbgType.setIcon(new ImageIcon(this.getClass().getResource("/screenSummer.png")));
